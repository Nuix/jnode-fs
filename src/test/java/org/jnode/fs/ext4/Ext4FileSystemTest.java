...
public class Ext4FileSystemTest
{
    ...
    @Test
    public void testReadExt464bit() throws Exception
    {
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-64bit.dd"), "r");
    ...
    @Test
    public void testReadExt4SeLinux() throws Exception
    {
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-selinux.dd"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    @Test
    public void testReadExt4Inline() throws Exception
    {
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/inline.dd"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    {
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/test-special-files.ext4"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    public void testReadExt4Mmp() throws Exception
    {
        ...
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-mmp.dd"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    public void testReadExt4LargeDirectory() throws Exception
    {
        ...
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-large-directory.dd"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    public void testReadExt4LargeDirectoryWithIndex() throws Exception
    {
        ...
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-large-dir-with-index.dd"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    {
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-flex-bg.img"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
    ...
    {
        Device device = new FileDevice(FileSystemTestUtils.getTestFile("org/jnode/fs/ext4/ext4-meta-bg.dd"), "r");
        Ext2FileSystemType type = fss.getFileSystemType(Ext2FileSystemType.ID);
        Ext2FileSystem fs = type.create(device, true);
