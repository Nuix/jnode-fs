...
public class NtfsReparsePointTest {
    ...
    @Test
    public void testResidentReparsePoint() throws Exception {
        ...
        ReparsePointAttributeRes reparsePointAttributeRes =
                (ReparsePointAttributeRes) NTFSTestRecords.attribute(data);
