...
/**
 * Tests for <a href="https://pypi.org/project/lznt1/">Python lznt1</a>
 * It's <a href="https://github.com/you0708/lznt1/blob/master/lznt1.py">Python lznt1 py</a>
...
public class Pylnzt1Test {
    ...
    public void testDecompression_the_original_jnode() throws IOException {
        byte[] compressed = FileSystemTestUtils.readFileToByteArray("org/jnode/fs/ntfs/compressed.bin");
        byte[] uncompressed = new byte[0x200000];

        // Act
        CompressedDataRunOriginal.unCompressUnit(compressed, uncompressed);

        byte[] expectedUncompressed = FileSystemTestUtils.readFileToByteArray("org/jnode/fs/ntfs/decompressed.bin");
        ...
        assertThat(uncompressedContent.endsWith(FILE_END), is(true)); // Near the end of the chunk
    }
    ...
    public void testDecompression_data_generated_by_python_lznt() throws IOException {
        ...
        // Assert
        String uncompressedContent = new String(uncompressed, StandardCharsets.US_ASCII);
        assertThat(uncompressedContent.contains(FILE_END), is(true)); // Near the end of the chunk
    }
